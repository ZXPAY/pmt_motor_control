...
#ifndef _MKV30F12810_H_
#define _MKV30F12810_H_                          /**< Symbol preventing repeated inclusion */
#include <stdint.h>
...
#elif defined(volatile const __IAR_SYSTEMS_ICC__)
...
typedef struct {
  volatile uint8_t CHCFG[4];                           /**< Channel Configuration register, array offset: 0x0, array step: 0x1 */
} DMAMUX_Type;
...
typedef struct {
  ...
  volatile uint32_t TAGVDW0S[8];                       /**< Cache Tag Storage, array offset: 0x100, array step: 0x4 */
  volatile uint32_t TAGVDW1S[8];                       /**< Cache Tag Storage, array offset: 0x120, array step: 0x4 */
  volatile uint32_t TAGVDW2S[8];                       /**< Cache Tag Storage, array offset: 0x140, array step: 0x4 */
  volatile uint32_t TAGVDW3S[8];                       /**< Cache Tag Storage, array offset: 0x160, array step: 0x4 */
...
typedef struct {
  ...
  volatile uint8_t FPROT0;                             /**< Program Flash Protection Registers, offset: 0x13 */
       uint8_t RESERVED_0[4];
  volatile const  uint8_t XACCH3;                             /**< Execute-only Access Registers, offset: 0x18 */
  volatile const  uint8_t XACCH2;                             /**< Execute-only Access Registers, offset: 0x19 */
  volatile const  uint8_t XACCH1;                             /**< Execute-only Access Registers, offset: 0x1A */
  volatile const  uint8_t XACCH0;                             /**< Execute-only Access Registers, offset: 0x1B */
  volatile const  uint8_t XACCL3;                             /**< Execute-only Access Registers, offset: 0x1C */
  volatile const  uint8_t XACCL2;                             /**< Execute-only Access Registers, offset: 0x1D */
  volatile const  uint8_t XACCL1;                             /**< Execute-only Access Registers, offset: 0x1E */
  volatile const  uint8_t XACCL0;                             /**< Execute-only Access Registers, offset: 0x1F */
  volatile const  uint8_t SACCH3;                             /**< Supervisor-only Access Registers, offset: 0x20 */
  volatile const  uint8_t SACCH2;                             /**< Supervisor-only Access Registers, offset: 0x21 */
  volatile const  uint8_t SACCH1;                             /**< Supervisor-only Access Registers, offset: 0x22 */
  volatile const  uint8_t SACCH0;                             /**< Supervisor-only Access Registers, offset: 0x23 */
  volatile const  uint8_t SACCL3;                             /**< Supervisor-only Access Registers, offset: 0x24 */
  volatile const  uint8_t SACCL2;                             /**< Supervisor-only Access Registers, offset: 0x25 */
  volatile const  uint8_t SACCL1;                             /**< Supervisor-only Access Registers, offset: 0x26 */
  volatile const  uint8_t SACCL0;                             /**< Supervisor-only Access Registers, offset: 0x27 */
  volatile const  uint8_t FACSS;                              /**< Flash Access Segment Size Register, offset: 0x28 */
       uint8_t RESERVED_1[2];
  volatile const  uint8_t FACSN;                              /**< Flash Access Segment Number Register, offset: 0x2B */
} FTFA_Type;
...
typedef struct {
  ...
  volatile uint32_t PLACR;                             /**< Crossbar Switch (AXBS) Control Register, offset: 0xC */
...
typedef struct {
  volatile uint8_t CR;                                 /**< OSC Control Register, offset: 0x0 */
       uint8_t RESERVED_0[1];
  volatile uint8_t DIV;                                /**< OSC_DIV, offset: 0x2 */
} OSC_Type;
...
typedef struct {
  ...
  volatile uint32_t PODLY[2];                          /**< Pulse-Out n Delay register, array offset: 0x194, array step: 0x4 */
} PDB_Type;
...
typedef struct {
  ...
  volatile uint8_t RPFW;                               /**< Reset Pin Filter Width register, offset: 0x5 */
       uint8_t RESERVED_1[2];
  volatile uint8_t SSRS0;                              /**< Sticky System Reset Status Register 0, offset: 0x8 */
  volatile uint8_t SSRS1;                              /**< Sticky System Reset Status Register 1, offset: 0x9 */
} RCM_Type;
...
typedef struct {
  ...
  volatile uint32_t SOPT8;                             /**< System Options Register 8, offset: 0x101C */
       uint8_t RESERVED_3[4];
 ...
 *  0b0000..KVx0 Subfamily
 *  0b0001..KVx1 Subfamily
 *  0b0010..KVx2 Subfamily
 *  0b0011..KVx3 Subfamily
 *  0b0100..KVx4 Subfamily
 *  0b0101..KVx5 Subfamily
 *  0b0110..KVx6 Subfamily
 */
...
typedef struct {
  ...
  volatile uint8_t STOPCTRL;                           /**< Stop Control Register, offset: 0x2 */
...
typedef struct {
  ...
  union {                                          /* offset: 0xC */
    volatile uint32_t CTAR[2];                           /**< Clock and Transfer Attributes Register (In Master Mode), array offset: 0xC, array step: 0x4 */
    volatile uint32_t CTAR_SLAVE[1];                     /**< Clock and Transfer Attributes Register (In Slave Mode), array offset: 0xC, array step: 0x4 */
  };
       uint8_t RESERVED_1[24];
  volatile uint32_t SR;                                /**< Status Register, offset: 0x2C */
  ...
  volatile const  uint32_t TXFR0;                             /**< Transmit FIFO Registers, offset: 0x3C */
  volatile const  uint32_t TXFR1;                             /**< Transmit FIFO Registers, offset: 0x40 */
  volatile const  uint32_t TXFR2;                             /**< Transmit FIFO Registers, offset: 0x44 */
  volatile const  uint32_t TXFR3;                             /**< Transmit FIFO Registers, offset: 0x48 */
       uint8_t RESERVED_2[48];
  volatile const  uint32_t RXFR0;                             /**< Receive FIFO Registers, offset: 0x7C */
  volatile const  uint32_t RXFR1;                             /**< Receive FIFO Registers, offset: 0x80 */
  volatile const  uint32_t RXFR2;                             /**< Receive FIFO Registers, offset: 0x84 */
  volatile const  uint32_t RXFR3;                             /**< Receive FIFO Registers, offset: 0x88 */
} SPI_Type;
...
typedef struct {
  ...
  volatile const  uint8_t S1;                                 /**< UART Status Register 1, offset: 0x4 */
...
#elif defined(volatile constAR_SYSTEMS_ICC__)
