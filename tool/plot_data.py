...
def plot_data(file_marker, DELTA_T):
    ...
    plt.savefig(FIG_DIR+"/"+file_marker + '/angle_' + file_marker + '.png', dpi=300)
    ...
    plt.yticks(fontsize=20)
    fig.align_labels()
    plt.savefig(FIG_DIR+"/"+file_marker + '/scanglecum_er_' + file_marker + '.png', dpi=300)
    ...
    plt.plot(t, th_er)
    plt.grid(True)
    plt.xlabel('t (s)', fontsize=26, position=(1, 0))
    plt.ylabel('angle (deg)', fontsize=26, position=(0,1.05), rotation="horizontal")
    ...
    plt.yticks(fontsize=20)
    fig.align_labels()
    plt.savefig(FIG_DIR+"/"+file_marker + '/current_power_' + file_marker + '.png', dpi=300)
    ...
    plt.yticks(fontsize=20)
    fig.align_labels()
    plt.savefig(FIG_DIR+"/"+file_marker + '/sm_scanglecum_er_' + file_marker + '.png', dpi=300)
    ...
    plt.legend(['ia', 'ib'], fontsize=20)
    fig.align_labels()
    plt.savefig(FIG_DIR+"/"+file_marker + '/sm_current_pwm_' + file_marker + '.png', dpi=300)
    ...
    plt.yticks(fontsize=20)
    fig.align_labels()
    plt.savefig(FIG_DIR+"/"+file_marker + '/sm_current_power_' + file_marker + '.png', dpi=300)
